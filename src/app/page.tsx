import { SettingsTabs } from '@/componentes/SettingsTabs'
import * as Input from '@/componentes/Input'
import { Bold, Italic, Link, List, ListOrdered, Mail } from 'lucide-react'
import * as FileInput from '@/componentes/Form/FileInput'
import { Select } from '@/componentes/Form/Select'
import { SelectItem } from '@/componentes/Form/Select/SelectItem'
import { Textarea } from '@/componentes/Form/Textarea'
          ...
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Barros" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="victor.manoel8@hotmail.com"
              />
            </Input.Root>
          </div>
